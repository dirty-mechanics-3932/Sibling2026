...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    if (count % 50 == 10) {
      // m_robotContainer.setLimitSwitches();
      setAllianceBasedUponSwitch(m_robotContainer.m_opController);
    }
  }
  ...
  public static void setAllianceBasedUponSwitch(CommandXboxController operatorController) {
    Alliance allianceDS = DriverStation.getAlliance().orElseThrow();
    ...
    if (alliance != lastAlliance || count < 50) {
      ...
      // SmartDashboard.putString("AllianceSD", alliance.toString());
    }
